...
def ask():
    ...
    excel_text = "This is where you can add extracted content from Excel if needed."
    ...
    try:
        ...
        excel_text = df.astype(str).to_string(index=False)  # Convert whole sheet to string
